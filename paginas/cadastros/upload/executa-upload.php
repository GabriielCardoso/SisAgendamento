...
$caminho_absoluto = "../fotos-cadastros";
...
if(isset($_FILES['arquivo']['name'])):
    ...
    $nome_arquivo_novo = $idCadastro . $extensao;
    ...
    if(move_uploaded_file($arquivo_temporario,"$caminho_absoluto/$nome_arquivo_novo")):
        $sql = "UPDATE tbcadastros SET nomeFotoCadastro= '{$nome_arquivo_novo}' WHERE idCadastro = '{$idCadastro}'";
